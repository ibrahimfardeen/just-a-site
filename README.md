To run this project make sure you have node and npm installed on your computer if not then visit the following websites and install them first

1. https://nodejs.org/en 2. https://docs.npmjs.com/downloading-and-installing-node-js-and-npm
2. After downloading the project, unzip the project file and open the project file in any text editor.
...
4. Now open your XAMPP control panel and press start on Apache and MySQL modules.
...
10. Now type "localhost:7000" on your browser and you will see the project's home page.
